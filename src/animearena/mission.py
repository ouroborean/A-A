...
mission_db = {
                ...
                "toga": (Mission(max=400, description="Deal affliction damage with Vacuum Syringe."),
                         ...
                         Mission(max=10, description="Win games while transformed."),
                         Mission(max=5, description="Win games while untransformed.")),
                ...
                "natsu": (Mission(max=500, description="Deal affliction damage with Natsu's abilities."),
                          ...
                          Mission(max=25, description="Deal killing blows with Natsu."),
                ...
                "kuroko": (Mission(max=50, description="Spend turns while invulnerable."),
                           ...
                           Mission(max=10, description="Use 4 different abilities without using the same ability twice in a row.")),
                ...
                "gokudera": (Mission(max=100, description="Progress the C.A.I. Stage."),
                             ...
                             Mission(max=10, description="After activating Vongola Box Weapon, use Sistema C.A.I. three turns in a row."),
                ...
                "tatsumi": (Mission(max=5, description = "Strike an enemy with Neuntote three turns in a row."),
                ...
                "byakuya": (Mission(max=25, description="Use Byakurai against enemies that were stunned by Six-Rod Light Restraint on the previous turn."),
