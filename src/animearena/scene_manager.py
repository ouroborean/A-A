...
class SceneManager:
    ...
    def __init__(self, window: sdl2.ext.Window = None, testing=False):
        self.username_raw = ""
        self.password_raw = ""
        self.frame_count = 0
        self.surfaces = dict()
        ...
        if not testing:
            ...
            self.surfaces["right_arrow"] = get_image_from_path("arrow_right.png")
            self.surfaces["left_arrow"] = get_image_from_path("arrow_left.png")
